...
//        },
        ...
        methods: {
            ...
            shareQrcode(id) {
                ...
                let names = getUser();
                let share_name = `${names.substring(0, 1)}经理`;
                let urls = _this.utf16to8(`https://cw.lzdu.com/#/preview?id=${id}&share_id=${share_id}&phone=${phone}&share_name=${share_name}`);
            ...
            read(id) {
                ...
                let detail = layer.open({
                    ...
                    shade: 0.8,
                    area: ['100%', '100%'],
                    content: `https://cw.lzdu.com/#/preview?id=${id}&share_id=${share_id}&phone=${phone}&share_name=${share_name}` //iframe的url
                });
